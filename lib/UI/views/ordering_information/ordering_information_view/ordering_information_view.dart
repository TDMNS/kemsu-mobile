    ...
    children: <Widget>[
      ...
      model.studyCard != null
          ? mainDropdown(context,
              ...
              textHint: Localizable.orderingInformationMainStudyBasis, onChanged: (value) {
      ...
      model.selectedBasic != null
          ? mainDropdown(context,
              ...
              textHint: Localizable.orderingInformationPeriod, onChanged: (value) {
      ...
      model.lastParagraph == model.selectedPeriod && model.isSelected == true
          ...
          : const SizedBox.shrink(),
      model.lastParagraph == model.selectedPeriod && model.isSelected == true ? const SizedBox.shrink() : const SizedBox(height: 20),
